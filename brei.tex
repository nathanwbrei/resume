...
\section{EXPERIENCE}
 ...
 Contributed to the rapid development and successful completion of Makani's new integrated ground station, a mobile system acting as an anchor, a winch, a perch, and a battery array for the Wing 7 airborne wind turbine. Focused on the design/implementing/testing of structural elements and chain drives. Prototyping was coupled with extensive CAD (with SolidWorks, NX) and FEA (with CosmosWorks). Upon completion, built composite parts for Wing 7.
